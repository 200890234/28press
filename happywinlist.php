			...
			<DIV class="webgame-info-tabs">		  
			  <table width="100%" height="27" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td background="images/game2_04.jpg" class="font14">Winners of Draw# <?=$_GET["happyno"]?></td>
			  ...
			  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td bgcolor="#9F4F18"><table width="100%" border="0" cellpadding="0" cellspacing="1">
                      <tr>
                        <td height="28" align="center" background="images/happy16_40.jpg" bgcolor="#FFFFFF" class="font-white">user</td>
                        <td align="center" background="images/happy16_40.jpg" bgcolor="#FFFFFF" class="font-white">pressed (<?=$web_moneyname?>)</td>
				...
				$sql="Select points,hdpoints,uid from {$web_dbtop}game16_users_tz where NO=".intval($_GET["happyno"])." and hdpoints>0 Order by hdpoints desc";
				$query=$db->query($sql);
				...
				?>
                      <tr>
                        <td height="32" align="center" bgcolor="#FCF5E1" class="font12game"><a href="user.php?id=<?=$rs["uid"]?>" style="color:green;"><?=$rs["uid"]?></a><?// if($vip){?><!--<img src="images/vip.gif" />--><? //}?>&nbsp;<? showstars(userslive($maxexperience));?></td>
                        <td align="center" bgcolor="#FFFFFF" class="font12game"><?=number_format($rs["points"])?> <img src="<?=$web_moneypic?>" /></td>
                        <td align="center" bgcolor="#FFFFFF" class="font-red font12game"><?=number_format($rs["hdpoints"])?> <img src="<?=$web_moneypic?>" /></td>
                      </tr>
                      <?
				} 
				?>

                ...
                <tr>
                  <td bgcolor="#9F4F18"><form action="?act=save" method="post">
                      <table width="100%" border="0" cellpadding="0" cellspacing="1">
                        <tr>
                          <td height="28" colspan="4" bgcolor="#FFFFFF">&nbsp;&nbsp;<strong>select pattern£º
...
&nbsp;&nbsp;rename:
              ...
              <label>£º</label>
                        ...
                        <tr>
                          <td height="28" colspan="4" bgcolor="#FFFFFF" class="rf">&nbsp;&nbsp;<strong>standard mode£º</strong><span class="pointer" onclick="init()">reset</span>&nbsp;&nbsp;<span class="pointer" onclick="useModel(1)">all</span>&nbsp;&nbsp;<span class="pointer" onclick="useModel(2)">odd</span>&nbsp;&nbsp;<span class="pointer" onclick="useModel(3)">even</span>&nbsp;&nbsp;<span class="pointer" onclick="useModel(4)">big</span>&nbsp;&nbsp;<span class="pointer" onclick="useModel(5)">small</span>&nbsp;&nbsp;<span class="pointer" onclick="useModel(6)">middle</span>&nbsp;&nbsp;<span class="pointer" onclick="useModel(7)">edge</span></td>
                        </tr>
                        <tr>

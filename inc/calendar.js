...
document.writeln('<iframe id=meizzDateLayer Author=wayx frameborder=0 style="position: absolute; width: 184px; height: 223px; z-index: 9998; display: none"></iframe>'); 
strFrame='<style>'; 
...
{ 
        ...
        { 
            da.innerHTML="<b><font color=#B5C5D2>" + meizzWDay[i] + "</font></b>"; 
